...
//第一个不是直播源
//#define NSMoiveUrlTwo @"http://baobab.cdn.wandoujia.com/14468618701471.mp4"

//第二个是直播源
#define NSMoiveUrlTwo @"http://live.hkstv.hk.lxdns.com/live/hks/playlist.m3u8"


@interface BBSMovieViewController (){
...
@implementation BBSMovieViewController
#pragma mark - 横屏代码
...
- (void)viewDidLoad {
    ...
    layer.frame = CGRectMake(0, 0, _width, _height);//self.view.bounds;//全屏
...
-(void)makeUpMovieView{
    ...
    _topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, _width, _height * 0.15)];
    _topView.alpha = 0.5;
...
-(void)proView{
    ...
    _pro.frame = CGRectMake(0,_backView.frame.size.height-20, _width, 10);
    //进度条走过的颜色
...
#pragma mark 滑块
-(void)markSliderView{
    _slider = [[UISlider alloc] initWithFrame:CGRectMake(0, _backView.frame.size.height-27, _width, 15)];
...
#pragma mark 时间
-(void)makeTimeLab{
    _currentTimeLab = [[UILabel alloc]initWithFrame:CGRectMake(_width *0.86, _backView.frame.size.height-90, 100, 20)];
